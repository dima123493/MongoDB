...
public class MongoDBPractice {
    public static void main(String[] args) {
        MongoClient connectionToMongoDB = MongoDBClient.establishConnectionToMongoDB("mongodb+srv://myAtlasDBUser:myAtlasDBUser@myatlasclusteredu.w1dxyhm.mongodb.net/?retryWrites=true&w=majority");
